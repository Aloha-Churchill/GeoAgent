...
class SettingsDockWidget(QDockWidget):
    ...
    def _create_model_tab(self):
        ...
        credentials_form.addRow("vLLM API key:", self.vllm_key_input)

        self.vllm_base_url_input = QLineEdit()
        self.vllm_base_url_input.setPlaceholderText("http://localhost:8000/v1")
        credentials_form.addRow("vLLM base URL:", self.vllm_base_url_input)
