...
## Overview
An AI-powered extension for the [KADAS Albireo](https://www.kadas.org/) geospatial workstation that integrates Large Language Models (LLMs) to enable natural language interaction, automated spatial querying, and intelligent task assistance within the GIS interface.
